...
int main(int argc, const char* argv[])
{
    ...
    options.output << std::setprecision(16);
    ...
    case shape_type::multipoint_z:
        ...
        //! @todo Maybe this decision should be left to a per-geometry basis?
    ...
    {
        const SHPObject* object = SHPReadObject(shapefile, feature);
        if (object == nullptr)
        {
        ...
        // Have to cast away the const to delete the object :/
        SHPDestroyObject(const_cast<SHPObject*>(object));
    }
